...
const ar = {
  ...
  settings: {
    title: "الإعدادات",
    subtitle: "إعدادات مركز التحكّم — مكان مخصّص للمصادقة والتهيئة لاحقًا",
    authPlaceholder:
      "لم تُفعّل المصادقة بعد. تم تجهيز هذا المكان لإضافة تسجيل الدخول والصلاحيات في مرحلة قادمة.",
